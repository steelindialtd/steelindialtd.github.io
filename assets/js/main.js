...
$(document).ready(function () {
  ...
  headerHtml += '<a href="tel:+919914007779">+91 99140 07779</a>';
  headerHtml += '<a href="mailto:sarangacc77@gmail.com"><i class="fa fa-envelope"></i> Mail Us</a>';
  headerHtml += '</div>';
  headerHtml += '</div>';
  headerHtml += '</div>';
  headerHtml += '</div>';
  ...
  headerHtml += '<div id="logo"><a href="index.html"><h1>Steel Sales India Ltd</h1></a></div>';
  ...
  headerHtml += '<li><a href="service.html">Service</a></li>';
  ...
  footerHtml += '<p>steel sales india is a sister concern of <a href="#">ACC Structures Ludhiana</a> <br><a routerLink="/about">read more..</a></p>';
  footerHtml += '</div>';
  footerHtml += '</div>';
  footerHtml += '<div class="col-lg-5  col-md-6 col-sm-6">';
  footerHtml += '<div class="single-footer-widget">';
